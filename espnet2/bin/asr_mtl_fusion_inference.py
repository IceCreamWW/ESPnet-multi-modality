...
class Speech2Text:
    ...
    def __init__(
        ...
        # 1. Build ASR model
        scorers = {}
        asr_model, asr_train_args = ASRMTLFusionTask.build_model_from_file(
    ...
    def __call__(
        ...
        # b. Forward Encoder
        enc, _ = self.asr_model.encode_speech(**batch)
...
def inference(
    ...
    loader = ASRMTLFusionTask.build_streaming_iterator(
        data_path_and_name_and_type,
        dtype=dtype,
        batch_size=batch_size,
        key_file=key_file,
        num_workers=num_workers,
        preprocess_fn=ASRMTLFusionTask.build_preprocess_fn(speech2text.asr_train_args, False),
        collate_fn=ASRMTLFusionTask.build_collate_fn(speech2text.asr_train_args, False),
